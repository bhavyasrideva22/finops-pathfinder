  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-elevated hover:scale-105 transition-spring shadow-glow",
        assessment: "bg-gradient-secondary text-primary-foreground hover:bg-gradient-primary hover:scale-105 transition-spring",
        glowing: "bg-accent text-accent-foreground hover:shadow-glow hover:scale-105 transition-spring",
      },
      size: {
